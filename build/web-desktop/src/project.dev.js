  ...
  PlayChangeColor: [ function(require, module, exports) {
    ...
    var NewClass = function(_super) {
      ...
      function NewClass() {
        ...
        _this.color_bg = cc.Color.WHITE;
        return _this;
      }
      NewClass.prototype.start = function() {
        this.startRandom();
      };
      NewClass.prototype.randomRGB = function() {
        this.color_bg = cc.color(256 * Math.random(), 256 * Math.random(), 256 * Math.random());
      };
      NewClass.prototype.startRandom = function() {
        cc.log(this.name + ": startRandom");
        this.node.runAction(cc.sequence(cc.callFunc(this.randomRGB, this), cc.tintTo(2, this.color_bg.getR(), this.color_bg.getG(), this.color_bg.getB()), cc.callFunc(this.startRandom, this)));
      };
      __decorate([ property ], NewClass.prototype, "color_bg", void 0);
...
}, {}, [ "LanguageData", "LocalizedLabel", "LocalizedSprite", "SpriteFrameSet", "polyglot.min", "PlayChangeColor" ]);